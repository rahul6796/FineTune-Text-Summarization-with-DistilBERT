...
from src.textsummarizationv2.pipeline.model_evaluation_pipeline import ModelEvaluationPipeline
...
try:
    ...
    model_eval.main()
    logger.info(f'model evaluation completed successfully for stage :: {stage_name}')
except Exception as e:
    logger.error(f'model evaluation : : {e}')
